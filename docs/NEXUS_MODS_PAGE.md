...
[*] [b]Dynamic 3D Head-Height Elevation Targeting:[/b] Resolves actual head bone world transforms for both actors. Seated characters (e.g. Camilla Valerius) look up naturally toward standing players, standing NPCs look down at seated/leaning characters (Lucan Valerius), and crouching smoothly adapts gaze elevation in real time.
[*] [b]3rd-Person Player Conversational Gaze:[/b] Your player character naturally turns and tracks conversation partners in third person.
...
[*] [b]Option 1: Superman Laser Eyes (Ocular Rays):[/b]
  [list]
  [*] Renders pencil-thin (~8mm) laser rays originating precisely from pupil socket anchors.
  [*] Scaled dynamically to target distance or [font=Courier New]fGazeRayLengthMeters[/font].
  [*] Follows ocular line of sight ballistically rather than static head rotation.
  [/list]
[*] [b]Option 2: HCEP Floating Diagram Panel:[/b]
  [list]
  [*] Renders a floating 3D planar quad displaying the chroma-keyed HCEP-02 ocular diagram ([font=Courier New]GazeRegionPanel.nif[/font] / [font=Courier New]GazeRegionPanel.dds[/font]).
  [*] Head-anchored and floating ~35cm in front of actor eyes, oriented toward the camera.
  [*] Dynamic real-time emissive glow highlights active gaze regions (Social Triangle, Mutual Gaze, Intimate, Avoidance, Target/Distraction).
  [/list]
[*] [b]Verified Light Emitter Fallback:[/b] Seamlessly defaults to the verified [b][font=Courier New]NiPointLight[/font] emitter fallback[/b] ([font=Courier New]TrueGaze_PupilLight[/font], [font=Courier New]TrueGaze_TerminusLight[/font])—attaching subtle gold point lights to the pupils and gaze terminus.
[/list]
...
[size=4][b]Mod Organizer 2 / Vortex / Direct SKSE Launch:[/b][/size]
[list=1]
[*] Download [font=Courier New]TrueGaze-v1.0.0-SkyrimSE-AE-VR.zip[/font].
[*] Install with your mod manager (MO2 / Vortex) and enable the mod.
[*] Launch Skyrim via [font=Courier New]skse64_loader.exe[/font] or [font=Courier New]sksevr_loader.exe[/font] (or your mod manager's SKSE button).
[*] TrueGaze operates 100% autonomously in-engine—no external processes or launcher windows needed!
[/list]

[size=4][b]Included Standalone Configurator Suite & Quickstart Guide:[/b][/size]
[list]
[*] [b]TrueGazeConfig.html:[/b] Open directly in any web browser to adjust sliders, inspect save games, and export your INI.
[*] [b]Launch-TrueGazeConfig.cmd:[/b] Double-click to start the automated local configuration bridge.
[*] [b]TrueGaze_Configurator_Guide.txt:[/b] Full step-by-step instructions included in the mod folder for adding the configurator to MO2/Vortex tool menus and troubleshooting.
[/list]
...
[list]
[*] [font=Courier New][b]tgstatus[/b][/font] — Display live runtime status, tracked actor count, bio-latency, blinks, and active kinematics state.
[*] [font=Courier New][b]tg[/b][/font] — Toggle the gaze engine on/off globally.
[*] [font=Courier New][b]tgvisuals[/b][/font] / [font=Courier New][b]tgv[/b][/font] — Toggle developer diagnostic visuals (rays, floating diagram panel, point lights).
[*] [font=Courier New][b]tgmode[/b][/font] — Cycle render modes (0 = Both, 1 = Light Only, 2 = Geometry Only).
...
Size:          4.40 MB (4,612,955 bytes)
SHA-256:       C41369DCACC4C93D50C5348844830EFA13CBF1B80C56CD8E2FECF225573F05EC

Package:       TrueGaze-v1.0.0-Symbols.zip
Size:          5.44 MB (5,709,040 bytes)
SHA-256:       4089CBA5B76F7CE009CC9794D2D6455D96C72BDF08D8E396EB2A2773BF119693
[/code]
